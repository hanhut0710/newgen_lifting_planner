...
export const Sidebar = ({ activeTab, onTabChange, onNewWorkout }) => {
    const navItems = [
    ...
    return (
        <aside className="hidden lg:flex flex-col w-72 h-screen sticky top-0 bg-background-dark border-r border-primary/10 p-6">
            <div className="flex items-center gap-3 mb-12 px-2">
                ...
                <span className="text-xl font-black tracking-tight text-white">FitSync</span>
            </div>
            ...
            <nav className="flex-1 space-y-2">
                {navItems.map((item) => (
                    <button
                        ...
                        className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all font-bold ${activeTab === item.id
            ...
            <div className="mt-auto space-y-4">
                ...
                <div className="flex items-center gap-3 p-3 rounded-2xl bg-primary/5 border border-primary/10">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[10px] text-primary/60 font-bold uppercase tracking-wider">{CURRENT_USER.role}</p>
                    </div>
